...
if trainingMode==0
    save 'tmp_data/BC_L5_Train288' trainData yTrain
elseif trainingMode==1
   save 'tmp_data/BC_L7_allvesselsTrain_OnlyC' trainData yTrain
elseif trainingMode==2
    save 'tmp_data/tm2_oob_L5_Train288' trainData yTrain
elseif trainingMode==3
    save 'tmp_data/tm3_L5_Train288' trainData yTrain
elseif trainingMode==4
    save 'tmp_data/tm4_L5_Train288' trainData yTrain
else
