%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%   Adaptative ROI analysis in CPR Vessels (Circle)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Author: E. Correa, March 17, 2013
% V: CPR.mhd
% Based on:
% Uso de FLUX como segmentacion de region a-priori de interes 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%         hold off
        % Flux maximun curve
        subplot(wGrid,wGrid,4)
         plot(linspace(0,R0*info.PixelDimensions(1),numel(Circleflux)),Circleflux), grid on; 
        %pause(0.004)
        %key=input('input');
...
% figure,title('Burrer 2nd order filter')
% subplot(2,2,1)
% plot(filter(B,A,meanV)),title('Mean Value roi Image');grid
% subplot(2,2,3)
% plot(filter(B,A,stdV)),title('std Value roi Image');grid
% subplot(2,2,2)
% plot(filter(B,A,meanGrad)),title('Mean Value roi gradient Image');grid
% subplot(2,2,4)
% plot(filter(B,A,stdGrad)),title('std Value roi gradient Image');grid
